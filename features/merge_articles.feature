...
I want to be able to merge two similar articles
  ...
  Scenario: Admin successfully merges two articles
    ...
    And An article exists with the title: "Mergable article"
    ...
    Then I should see the message "Article merged!"
  ...
  Scenario: When articles are merged, the merged article should contain the text of both previous articles
    Given I am logged in as an admin
    And An article exists with the title: "Original Article"
    And An article exists with the title: "New Article"
